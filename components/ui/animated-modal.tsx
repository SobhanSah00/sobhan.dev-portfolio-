      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ref={modalRef}
            className={cn(
              "w-full max-w-2xl max-h-[90vh] bg-white dark:bg-neutral-950 border border-transparent dark:border-neutral-800 rounded-2xl relative z-50 flex flex-col overflow-hidden",
              className
            )}
            initial={{
              opacity: 0,
...
export const ModalContent = ({
  ...
  return (
    <div className={cn("flex flex-col flex-1 p-8 md:p-10 overflow-y-auto scrollbar-hide", className)}>
      <style jsx>{`
        .scrollbar-hide {
